...
import com.service.impl.JieyueServiceImpl;
...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (myThreadMethod == null) {
            ...
            JieyueService jieyueService = (JieyueService)appContext.getBean("jieyueService");
            myThreadMethod.setJieyueService(jieyueService);
