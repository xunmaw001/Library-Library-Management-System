...
public class TushuChuruInoutView extends TushuChuruInoutEntity implements Serializable {
	...
	public TushuChuruInoutView() {

	}

	public TushuChuruInoutView(TushuChuruInoutEntity tushuChuruInoutEntity) {
		try {
			BeanUtils.copyProperties(this, tushuChuruInoutEntity);
