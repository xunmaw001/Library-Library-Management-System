...
//                            yonghuEntity.setXibieTypes(Integer.valueOf(data.get(0)));   //系别 要改的
//                            yonghuEntity.setBanjiTypes(Integer.valueOf(data.get(0)));   //班级 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //邮箱 要改的
//                            yonghuEntity.setYonghuUuidNumber(data.get(0));                    //图书证号 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [图书证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
