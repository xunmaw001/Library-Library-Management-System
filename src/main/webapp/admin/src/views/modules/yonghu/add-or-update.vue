        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="系别" prop="xibieTypes">
                        <el-select v-model="ruleForm.xibieTypes" :disabled="ro.xibieTypes" placeholder="请选择系别">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="图书证号" prop="yonghuUuidNumber">
                       <el-input v-model="ruleForm.yonghuUuidNumber"
                                 placeholder="图书证号" clearable  :readonly="ro.yonghuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuUuidNumber: [
                              { required: true, message: '图书证号不能为空', trigger: 'blur' },
                          ],
                   jieyueshuliang: [
