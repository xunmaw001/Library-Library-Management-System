        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '图书证号' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.yonghuUuidNumber" placeholder="图书证号" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/tushuguanshuku/upload/jieyueMuBan.xls"
                        >批量导入借阅记录数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jieyue','导入导出')"
                                style="display: inline-block"
                                action="tushuguanshuku/file/upload"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('jieyue','还书') && scope.row.jieyueTypes != 2" type="primary" icon="el-icon-edit" size="mini" @click="huanshu(scope.row.id,scope.row.yonghuId,scope.row.tushuId)">还书</el-button>
